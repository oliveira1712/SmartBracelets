...
<html>
 ...
 <body>
  ...
  <div class="container" style="min-height: 60vh;">    
     <br />
     <h3 align="center" style="padding-top: 7rem;">CRUD Tabela TipoPromotores</h3>
     <br />
     <div align="right">
   ...
   <div class="table-responsive">
    <table id="user_table" class="table table-bordered table-striped">
     <thead>
      <tr>
            <th width="15%">idTpPromotor</th>
            <th width="35%">TipoPromotor</th>
        ...
        <div class="modal-body">
         ...
         <form method="post" id="sample_form" class="form-horizontal">
          ...
          <div class="form-group">
            <label class="control-label col-md-4" >TipoPromotor : </label>
            <div class="col-md-8">
             <input type="text" name="tipopromotor" id="tipopromotor" class="form-control" autocomplete="off" />
            </div>
           </div>
           <div class="form-group">
...
$(document).ready(function(){
 ...
 $('#user_table').DataTable({
  ...
  ajax: {
   url: "{{ route('admin.TipoPromotores.index') }}",
  },
  columns: [
    {
    data: 'idtppromotor',
 ...
 $('#sample_form').on('submit', function(event){
  ...
  if($('#action').val() == 'Add')
  {
   action_url = "{{ route('admin.TipoPromotores.store') }}";
  }

  if($('#action').val() == 'Edit')
  {
    $('#formModal').modal('hide');
   action_url = "{{ route('admin.TipoPromotores.update') }}";
  }
 ...
 $(document).on('click', '.edit', function(){
  ...
  $.ajax({
   ...
   url :"/admin/TipoPromotores/"+id+"/edit",
   dataType:"json",
   success:function(data)
   {
       
    $('#tipopromotor').val(data.result.tipopromotor);
 ...
 $('#ok_button').click(function(){
  $.ajax({
   url:"/admin/TipoPromotores/destroy/"+user_id,
   beforeSend:function(){
