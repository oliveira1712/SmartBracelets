...
<html>
 ...
 <body>
  ...
  <div class="container" style="min-height: 60vh;">    
     <br />
     <h3 align="center" style="padding-top: 7rem;">CRUD Tabela Preco Eventos</h3>
     <br />
     <div align="right">
        ...
        <div class="modal-body">
         ...
         <form method="post" id="sample_form" class="form-horizontal">
          ...
          <div class="form-group">
           ...
           <div class="form-group">
            <label class="control-label col-md-4">Preco : </label>
            <div class="col-md-8">
...
$(document).ready(function(){
 ...
 $('#user_table').DataTable({
  ...
  ajax: {
   url: "{{ route('admin.PrecoEventos.index') }}",
  },
  columns: [
    {
    data: 'evento',
 ...
 $('#sample_form').on('submit', function(event){
  ...
  if($('#action').val() == 'Add')
  {
   action_url = "{{ route('admin.PrecoEventos.store') }}";
  }

  if($('#action').val() == 'Edit')
  {
    $('#formModal').modal('hide');
   action_url = "{{ route('admin.PrecoEventos.update') }}";
  }
 ...
 $(document).on('click', '.edit', function(){
  ...
  $('#form_result').html('');
  $.ajax({
   url :"/admin/PrecoEventos/"+id+"/edit",
   dataType:"json",
   success:function(data)
   {
 ...
 $('#ok_button').click(function(){
  $.ajax({
   url:"/admin/PrecoEventos/destroy/"+user_id,
   beforeSend:function(){
